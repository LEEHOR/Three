...
public abstract class BaseCheckPermissionFragment extends BaseFragment implements ActivityCompat.OnRequestPermissionsResultCallback {
    private static final int REQUEST_CODE_PERMISSON = 2021; //权限请求码
    ...
    protected void showTipsDialog() {
        ...
        new AlertDialog.Builder(getActivity()).setTitle("提示信息").setMessage("当前应用缺少" + getDialogTipsPart()
