...
import net.coahr.three3.three.Util.OtherUtils.LogUtils;
...
public class NotifyUtils {
   ...
   private NotificationChannel channel;//8.0
    ...
    public NotifyUtils(Context context, int ID,String channelId ) {
        ...
        nm = (NotificationManager) mContext
         ...
         largeIcon = ((BitmapDrawable) mContext.getResources().getDrawable(R.mipmap.ic_launcher)).getBitmap();
...
//                requestCode, intent, FLAG);
        ...
        cBuilder.setSmallIcon(R.drawable.ic_shortcut_smallnotifi);// 设置顶部状态栏的小图标
...
//            Toast.makeText(mContext, "您的手机低于Android 4.1.2，不支持多行通知显示！！", Toast.LENGTH_SHORT).show();
     ...
     * 根据id清除通知
     */
    public void clearAllNotificationById(int id) {
        // 取消通知
