...
import net.coahr.three3.three.Util.imageselector.utils.ImageUtil;
import net.coahr.three3.three.Util.imageselector.utils.StringUtils;
import net.coahr.three3.three.Util.imageselector.view.ClipImageView;
...
public class ClipImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picselect_clip_image);
