...
import net.coahr.three3.three.Util.imageselector.adapter.ImagePagerAdapter;
...
import net.coahr.three3.three.Util.imageselector.view.MyViewPager;
...
public class PreviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picselect_preview);
