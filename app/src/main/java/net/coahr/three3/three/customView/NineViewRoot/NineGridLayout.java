package net.coahr.three3.three.customView.NineViewRoot;
...
public abstract class NineGridLayout extends ViewGroup {
    ...
    public NineGridLayout(Context context, AttributeSet attrs) {
       ...
       /* FrameLayout.LayoutParams fp = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT , FrameLayout.LayoutParams.WRAP_CONTENT);
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NineGridLayout2);
        mSpacing = typedArray.getDimension(R.styleable.NineGridLayout2_sapcing2, DEFUALT_SPACING);
        oneImageWidth = (int) typedArray.getDimension(R.styleable.NineGridLayout2_oneImageWidth2, 0);
        oneImageHeight = (int) typedArray.getDimension(R.styleable.NineGridLayout2_oneImageHeight2, 0);
        image_ratio =   typedArray.getFloat(R.styleable.NineGridLayout2_image_ratio2, image_ratio);
        typedArray.recycle();
        init(context);
    }
    ...
    public void setUrlList(List<String> urlList) {
        if (getListSize(urlList) == 0) {
            ...
            removeAllViews();
            setVisibility(INVISIBLE);
            Log.e(TAG, "setUrlList: +Invisible");
            return;
        }
        setVisibility(VISIBLE);
    ...
    private void refresh() {
        ...
        if (size > 0) {
            ...
            RatioImageView imageView = createImageView(0, null);
            setVisibility(INVISIBLE);
            return;
        }
    ...
    private RatioImageView createImageView(final int i, final String url) {
        ...
        imageView.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                onLongClickImage(i, url, mUrlList,imageView);
                return true;
            }
        });
        return imageView;
    ...
    protected  abstract void onLongClickImage(int position, String url, List<String> urlList,ImageView imageView);
}
